...
function augment(regex, captureNames, xSource, xFlags, isInternalOnly) {
    ...
    // Emulate the ES6 `flags` prop by ensuring flags are in alphabetical orders
...
/**
 * Runs built-in and custom regex syntax tokens in reverse insertion orders at the specified
...
function runTokens(pattern, flags, pos, scope, context) {
    ...
    // Run in reverse insertion orders
    while (i--) {
        t = tokens[i];
        if (
...
function XRegExp(pattern, flags) {
    ...
    if (!patternCache[pattern][flags]) {
        ...
        patternCache[pattern][flags] = {
            ...
            // groups are sometimes inserted during regex transpilation in orders to keep tokens
 ...
 * @param {Number} [limit] Maximum number of products to include in the result array.
